...
def populate_table_CARGOS(file_information):
    ...
    (:DESCRICAO, :SALARIO_BASE, :NIVEL_CARGO, :IMPORTANCIA)""",
    [
...
def main():
    file_name = "C:/Users/gribe/OneDrive/Documentos/Codes/INFNET/2024.1/Projeto de Bloco - Fundamentos de Dados/TPs/TP3/resources/cargos.csv"
